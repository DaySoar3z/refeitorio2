...
from refeitorioApp.views import home, new_aluno, editar_aluno, excluir_aluno, evento, editar_evento,excluir_evento
...
urlpatterns = [
    ...
    path('evento/excluir/<int:id>/', excluir_evento, name='excluir_evento'),
